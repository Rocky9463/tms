<?php
	...
	if(isset($_POST["export_data"])) {	
		$filename = "Tenant_record_".date('Ymd') . ".xls";			
	...
	<table>
		...
		<tbody>
			<?php foreach($developer_records as $developer) { ?>
			   ...
			   <td><?php echo $developer ['mob']; ?></td>
			   <td><?php echo date("d-m-Y", strtotime($developer ['moveindate'])); ?></td> 
			   <td><?php echo $developer ['aadhar']; ?></td> 
			   </tr>
			<?php } ?>
		</tbody>
    </table>
...
<a href="managetenant.html"><img src="images/back2.png" id="back_btn"></a>
</body>
</html>